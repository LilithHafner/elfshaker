...
mod tests {
    ...
    fn assign_to_frames_single_works() {
        ...
        let entries = [
            FileEntry::new("A".into(), [0; 20], make_md(50, 1), None),
            FileEntry::new("B".into(), [1; 20], make_md(50, 1), None),
        ];
    ...
    fn assign_to_frames_multiple_works() {
        ...
        let entries = [
            FileEntry::new("A".into(), [0; 20], make_md(800, 200), None),
            FileEntry::new("B".into(), [1; 20], make_md(1200, 200), None),
        ];
        let frame_1_entries = [
            // Offset is same
            FileEntry::new("A".into(), [0; 20], make_md(800, 200), None),
        ...
        let frame_2_entries = [
            // Offset 1200 -> 200
            FileEntry::new("B".into(), [1; 20], make_md(200, 200), None),
        ];
        let result = assign_to_frames(&frames, &entries).unwrap();
